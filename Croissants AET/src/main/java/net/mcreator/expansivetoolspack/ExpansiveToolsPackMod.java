package net.mcreator.expansivetoolspack;
...
import net.mcreator.expansivetoolspack.init.ExpansiveToolsPackModTabs;
...
@Mod("expansive_tools_pack")
public class ExpansiveToolsPackMod {
	public static final Logger LOGGER = LogManager.getLogger(ExpansiveToolsPackMod.class);
	public static final String MODID = "expansive_tools_pack";

	public ExpansiveToolsPackMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		ExpansiveToolsPackModItems.REGISTRY.register(modEventBus);
		ExpansiveToolsPackModTabs.REGISTRY.register(modEventBus);
